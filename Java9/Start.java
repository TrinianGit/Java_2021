...
class Panel extends JPanel{
    ...
    public void paintComponent(Graphics g) {
        ...
        Marginesx = (double) ((getWidth() - GraphWidth * Wspolczynnikx) / 2.0);
        Marginesy = (double) ((getHeight() - GraphHeight * Wspolczynniky) / 2.0);
        if (GraphHeight == 0 && GraphWidth == 0){
            if (getWidth() > getHeight()){
        ...
        for (int i = 0; i < GraphPoints.size(); i++){
            ...
            g2d.drawOval((int) (Marginesx + GraphPoints.get(i).getCol() * Wspolczynnikx - MinimalWidth * Wspolczynnikx), (int) (getHeight() - GraphPoints.get(i).getRow() * Wspolczynniky + MinimalHeight * Wspolczynniky - Marginesy), WspolczynnikKola, WspolczynnikKola);
            g2d.dispose();
        }
        for (var i : GraphConnections.keySet()){
            Graphics2D g2d = (Graphics2D) g.create();
            g2d.setStroke(new BasicStroke((float) searchMaxInMap(i)));
            g2d.drawLine((int) (Marginesx + GraphPoints.get(i.getCol()-1).getCol() * Wspolczynnikx + 5 - MinimalWidth * Wspolczynnikx), (int) (getHeight() - GraphPoints.get(i.getCol() - 1).getRow() * Wspolczynniky + MinimalHeight * Wspolczynniky + 5 - Marginesy), (int) (Marginesx + GraphPoints.get(i.getRow() - 1).getCol() * Wspolczynnikx + 5 - MinimalWidth * Wspolczynnikx), (int) (getHeight() - GraphPoints.get(i.getRow()-1).getRow() * Wspolczynniky + MinimalHeight * Wspolczynniky + 5 - Marginesy));
            g2d.dispose();
        }
    ...
    private Double FindWspolczynnik() {
        ...
        if (SearchGraphHeight() != 0){
            for (WspolczynnikHeight = 1.0; WspolczynnikHeight * (double) SearchGraphHeight() < ((double)getHeight() - 20.0); WspolczynnikHeight += 1.0);
            WspolczynnikHeight -= 1.0;
        }
        if (SearchGraphWidth() != 0){
            for (WspolczynnikWidth = 1.0; WspolczynnikWidth * (double) SearchGraphWidth() < ((double)getWidth() - 20.0); WspolczynnikWidth += 1.0);
