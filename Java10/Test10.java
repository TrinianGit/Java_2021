...
public class Test10 {
  public static void main(String[] args) {
    ...
    // test 10: test sprawdza czy zawsze jak mozemy to wydajemy rozmienialne
    k = new Kasjer();
    k.dostępDoRozmieniacza(r);
    ...
    // test 11: wydawanie z malych rozmienialnych gdy w kasie daloby sie to zrobic takze z NR (przypadek gdy NR i R maja identyczne wartosci)
    k = new Kasjer();
    k.dostępDoRozmieniacza(r);
    k.dostępDoPoczątkowegoStanuKasy(new Sup(new Pieniadz[] {new Pieniadz(Nominal.Zł1, Rozmienialnosc.TAK), new Pieniadz(Nominal.Zł2, Rozmienialnosc.TAK), 
    new Pieniadz(Nominal.Zł2, Rozmienialnosc.TAK), new Pieniadz(Nominal.Zł1, Rozmienialnosc.NIE), new Pieniadz(Nominal.Zł2, Rozmienialnosc.NIE), 
    new Pieniadz(Nominal.Zł2, Rozmienialnosc.NIE)}));
    reszta = k.rozlicz(5, List.of(new Pieniadz(Nominal.Zł10, Rozmienialnosc.NIE)));
    kasa = k.stanKasy();
    if (reszta.stream().mapToInt(Pieniadz::wartosc).sum() != 10 + 5)
    throw new RuntimeException("Nieprawidlowa suma reszty");
    ...
    //Test 12: własny test na głupotę
    k = new Kasjer();
    k.dostępDoRozmieniacza(r);
    k.dostępDoPoczątkowegoStanuKasy(new Sup(new Pieniadz[] {new Pieniadz(Nominal.Zł5, Rozmienialnosc.TAK), new Pieniadz(Nominal.Zł2, Rozmienialnosc.NIE), 
    new Pieniadz(Nominal.Zł2, Rozmienialnosc.NIE), new Pieniadz(Nominal.Zł2, Rozmienialnosc.NIE), new Pieniadz(Nominal.Zł5, Rozmienialnosc.NIE)}));
    reszta = k.rozlicz(10, List.of(new Pieniadz(Nominal.Zł20, Rozmienialnosc.NIE)));
    kasa = k.stanKasy();
    if (reszta.stream().mapToInt(Pieniadz::wartosc).sum() != 20 + 10)
    throw new RuntimeException("Nieprawidlowa suma reszty");
    if (kasa.stream().mapToInt(Pieniadz::wartosc).sum() != 6)
      throw new RuntimeException("Nieprawidlowa kasa");
    r.serialNumberCheck2(kasa, reszta);

      //Test 13: Prawdopodobny OutOfRange
    k = new Kasjer();
    k.dostępDoRozmieniacza(r);
    k.dostępDoPoczątkowegoStanuKasy(new Sup(new Pieniadz[] {new Pieniadz(Nominal.Zł2, Rozmienialnosc.TAK), new Pieniadz(Nominal.Zł1, Rozmienialnosc.TAK), 
    new Pieniadz(Nominal.Zł5, Rozmienialnosc.NIE), new Pieniadz(Nominal.Zł2, Rozmienialnosc.NIE)}));
    reszta = k.rozlicz(4, List.of(new Pieniadz(Nominal.Zł10, Rozmienialnosc.NIE)));
    kasa = k.stanKasy();
    if (reszta.stream().mapToInt(Pieniadz::wartosc).sum() != 10 + 6)
    throw new RuntimeException("Nieprawidlowa suma reszty");
    if (kasa.stream().mapToInt(Pieniadz::wartosc).sum() != 4)
      throw new RuntimeException("Nieprawidlowa kasa");
    r.serialNumberCheck2(kasa, reszta);

         //Test 14: Pętla i nieoptymalne wydawanie
