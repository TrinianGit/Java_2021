...
public class Test {
  ...
  public static void main(String[] args) {
    ...
    expPair.put(b.new PairOfLines("b", "a"), new HashSet<Position>(List.of()));
    expPair.put(b.new PairOfLines("c", "b"), new HashSet<Position>(List.of()));
    expPair.put(b.new PairOfLines("a", "a"), new HashSet<Position>(List.of(new Position2D(4, 4))));
    expPair.put(b.new PairOfLines("b", "b"), new HashSet<Position>(List.of()));
    expPair.put(b.new PairOfLines("c", "c"), new HashSet<Position>(List.of()));
    expPair.put(b.new PairOfLines("a", "b"), new HashSet<Position>(List.of()));
    expPair.put(b.new PairOfLines("b", "c"), new HashSet<Position>(List.of()));
    expPair.put(b.new PairOfLines("a", "c"), new HashSet<Position>(List.of(new Position2D(7, 2), new Position2D(7, 4))));
    expPair.put(b.new PairOfLines("c", "a"), new HashSet<Position>(List.of(new Position2D(7, 2), new Position2D(7, 4))));
